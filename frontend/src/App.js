...
function App() {
  ...
  return (
    <div >
	  ...
	  {!genCitation?"":genCitation[0].retrievedReferences.map((reference, index) => (
	      <div>
		  <strong>Citation: </strong>
		  <ul>
		  <li>
		  <p id="citation-text">
		  <strong>Citation Text: </strong>{reference.content.text}
	          </p>
		  </li>
		  <li>
		  <p id="citation-source-uri">
		  <strong>Citation Source URI: </strong>{reference.metadata["x-amz-bedrock-kb-source-uri"]}
	          </p>
		  </li>
		  </ul>
	   </div>
